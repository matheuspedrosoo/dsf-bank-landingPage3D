...
export const experience = [
	{
		title: '10M',
		subtitle: 'De usuários satisfeitos que confiam no DSF como seu banco digital de escolha.',
		color: 'blue'
	},
	{
		title: '6 +',
		subtitle: 'Anos de experiência oferecendo serviços bancários inovadores, seguros e confiáveis.',
		color: 'orange'
	}
]
	...
	list: [
		{
			...
			subtitle: 'Conte com a mais avançada tecnologia de segurança para total segurança dos seus dados.'
		},
		{
			icon: computer,
			title: 'Experiência de usuário inovadora',
			subtitle: 'Estamos sempre empenhados em tornar a interação com nossos serviços o mais fácil e agradável possível.'
		},
		{
			icon: heart,
			title: 'Atendimento excepcional',
			subtitle: 'Nossa equipe está pronta para ajudá-lo a solucionar qualquer dúvida ou problema,'
		}
	]
}
